...
$editorial = isset($_GET['editorial']) ? $conexion->real_escape_string($_GET['editorial']) : "Image Comics";
...
$sql = "SELECT * FROM comics WHERE editorial = '$editorial'";
...
<head>
    ...
    <title>Comic House - Image Comics</title>
...
<header>
    ...
    <div class="Comics-titulo-2">
        <div class="titulo-comics-ctn-2">
            <h2>Catálogo de <?= htmlspecialchars($editorial) ?></h2>
        </div>
    </div>
